<template>
  <div class="base-info">
    <select-edition :edition.sync="edition"></select-edition>
    <el-row>
      <el-col :span="8">
    ...
    <!-- 附件 -->
    <div class="enclosure">
      <h5 class="enclosure-title">查看附件</h5>
